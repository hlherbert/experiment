...
import com.hl.gene.neo.tsp.TspCell;
import com.hl.gene.neo.tsp.TspCellFactory;
import com.hl.gene.neo.tsp.TspData;
import com.hl.gene.neo.tsp.TspIO;
import com.hl.gene.neo.tsp.TspProblem;
import com.hl.gene.neo.tsp.TspSolution;
    ...
    private void OpenFile() {
        ...
        for (final String[] fileEName : fileENames) {
            fileChooser.setFileFilter(new javax.swing.filechooser.FileFilter() {
                public boolean accept(File file) {
                    return file.getName().endsWith(fileEName[0])
                            || file.isDirectory();
                }
